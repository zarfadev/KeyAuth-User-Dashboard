    ...
    <div class="d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="sidebar-item"><a class="sidebar-link" href="/dashboard/pages/reset">
                        <svg class="svg-icon svg-icon-sm svg-icon-heavy">
                            <use xlink:href="#imac-screen-1"> </use>
                        </svg><span>Reset HWID </span></a></li>
            </ul><span class="text-uppercase text-gray-600 text-xs mx-3 px-2 heading mb-2">Extras</span>
            <ul class="list-unstyled">
                <li class="sidebar-item active"><a class="sidebar-link" href="/dashboard/pages/status">
                        <svg class="svg-icon svg-icon-sm svg-icon-heavy">
                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <table class="table mb-0 table-striped table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">Freefire</th>
                                                <td>2.1</td>
                                                <td>Updated on, Sunday, July 9, 2023</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>1.2</td>
                                                <td>Updated on, Sunday, May 19, 2023</td>
                                                <td>
                            ...
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <table class="table mb-0 table-striped table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">Bluestacks</th>
                                                <td>4.240.30.1002</td>
                                                <td>Best version for our panel</td>
                                                <td>
                                                    <a href="https://your-url.uk"
                                            ...
                                            <tr>
                                                <th scope="row">FreeFire</th>
                                                <td>OB40</td>
                                                <td>Best antiblacklist Freefire for our panel</td>
                                                <td>
                                                    <a href="https://your-url.uk"
                                                        class="btn btn-success btn-sm">Download</a>
                                                </td>
