...
{
    if ($timestamp === 0) {
        return "Nunca"; // Mostrar "Nunca" si el timestamp es 0
    }
    return date("d/m/Y h:i:s A", $timestamp); // Formato de fecha con AM/PM
}
    ...
    <div class="d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled">
                <li class="sidebar-item active"><a class="sidebar-link" href="/dashboard/home">
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-0">
                                <div class="card-header">
                                    <h3 class="h4 mb-0">Latest Purchases</h3>
                                </div>
